...
def handle_help(message):
    ...
    help_message = (
        ...
        "6 - Hate\n\n"
        "<b>Important notes:</b>\n"
        "• Sessions are only used during the current reporting process and not stored\n"
        "• You'll need to send your sessions.txt file for each new reporting process\n"
        "• Don't use very short wait times to avoid bans\n"
